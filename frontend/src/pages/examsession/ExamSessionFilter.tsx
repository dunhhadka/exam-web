...
interface Props {
  ...
  onFilterChange: (newFilter: ExamFilterRequest) => void
  onClose?: () => void
}

export const ExamSessionFilter = ({
  filter,
  onFilterChange,
  onClose,
}: Props) => {
  const [filterState, setFilterState] = useState<ExamFilterRequest>(filter)
    ...
    <FilterWrapper>
      ...
      <FilterContent>
        <FilterSection>
          <FilterRow>
            <FilterItem>
              <FilterLabel>Trạng thái công khai</FilterLabel>
              <Select
                ...
                options={[
                  ...
                  { label: 'Chỉ mình tôi', value: false },
                ]}
              />
            </FilterItem>
          </FilterRow>
          ...
          <FilterRow>
              ...
              <DatePicker
                ...
                value={
                  filterState.startDate
                    ? dayjs(filterState.startDate, 'DD-MM-YYYY')
                    : null
                }
                onChange={(date: Dayjs | null) =>
                  setFilterState({
                    ...filterState,
                    startDate: date ? date.format('DD-MM-YYYY') : undefined,
                  })
                }
                format="DD-MM-YYYY"
              />
            ...
            <FilterItem>
              ...
              <DatePicker
                ...
                value={
                  filterState.endDate
                    ? dayjs(filterState.endDate, 'DD-MM-YYYY')
                    : null
                }
                onChange={(date: Dayjs | null) =>
                  setFilterState({
                    ...filterState,
                    endDate: date ? date.format('DD-MM-YYYY') : undefined,
                  })
                }
                format="DD-MM-YYYY"
              />
